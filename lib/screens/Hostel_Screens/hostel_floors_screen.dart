...
import 'package:frontend/screens/Hostel_Screens/hostel_rooms_screen.dart';
import 'package:frontend/services/ip.dart';
import 'package:frontend/widgets/linear_progress_bar.dart';
import 'package:http/http.dart' as http;

class HostelsFLoorScreen extends StatefulWidget {
  final String type;
  const HostelsFLoorScreen({super.key, required this.type});

  @override
  State<HostelsFLoorScreen> createState() => _HostelsFLoorScreenState();
}

class _HostelsFLoorScreenState extends State<HostelsFLoorScreen> {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    HostelRoomsScreen(floorno: floor, type: widget.type)));
      },
      child: Container(
