...
import 'package:frontend/screens/Hostel_Screens/hostel_beds_screen.dart';
...
class HostelRoomsScreen extends StatefulWidget {
  ...
  const HostelRoomsScreen(
      {super.key, required this.floorno, required this.type});
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => HostelBedsScreen(
                                      beds: rooms[index].beds,
                                      roomno: rooms[index].roomNumber,
                                      type: widget.type,
                                      floorno: rooms[index].floorNumber,
                                    )));
                      },
                      child: Container(
